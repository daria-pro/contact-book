    ...
    return (React.createElement(Navbar_1["default"], { collapseOnSelect: true, expand: "lg", bg: "dark", variant: "dark", className: "nav" },
        React.createElement(Container_1["default"], { className: "nav-container px-3 px-md-5 p-lg-0" },
            React.createElement(Navbar_1["default"].Brand, null,
                React.createElement(react_router_dom_1.Link, { to: "/contact-book", className: "nav-logo" }, "CONTACT BOOK")),
            ...
            React.createElement(Navbar_1["default"].Collapse, { id: "responsive-navbar-nav" },
                React.createElement(Nav_1["default"], { className: "ms-auto" },
                    React.createElement(Nav_1["default"].Link, null,
                        React.createElement(react_router_dom_1.Link, { to: "/contact-book", className: "nav-link" }, "Home")),
                    React.createElement(Nav_1["default"].Link, null,
                        React.createElement(react_router_dom_1.Link, { to: "/contact-book/contacts", className: "nav-link" }, "Contacts")),
                    React.createElement(Nav_1["default"].Link, null,
                        React.createElement(react_router_dom_1.Link, { to: "/contact-book/about", className: "nav-link" }, "About")))))));
}
